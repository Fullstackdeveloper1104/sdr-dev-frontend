...
const Tab1 = ({tab1ProfileData, tab1data}) => {
    ...
    >
      <div class="">
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4">
          ...
          <YourProfile avatarLink ={tab1ProfileData.avatarLink} location={tab1ProfileData.location} fullname={tab1ProfileData.fullName} activesince={tab1ProfileData.activeSince} reportsto={tab1ProfileData.reportsTo} />
        </div>
      </div>
    </div>
  );
