...
const MangerDashboard = () => {
  ...
  const [tab1TeamMembers, setTab1TeamMembers] = useState([{
    name: "",
    FullName: '',
    AvatarLink: false,
  }
      ...
      if (response.status === 200) {
        ...
        response.json().then((data) => {
          ...
          if(data.dashboardData.query1.length===0) {
            ...
            setTab1TeamMembers(data.dashboardData.query1);
          }
          if(data.dashboardData.query2.length===0){
            ...
            if(data.dashboardData.query1[0].AppointmentGoal!==0 && combinedAppointmentGoal!==0){
  ...
  return (
    <Dashboard>
      ...
      <div class="mt-8 flex-1">
        {tabIndex == 0 && (
        <Tab1 tab1TeamMembers={tab1TeamMembers} tab1data={tab1data}/>
        )}
